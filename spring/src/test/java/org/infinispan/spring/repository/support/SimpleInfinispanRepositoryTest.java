package org.infinispan.spring.repository.support;
...
import org.infinispan.spring.repository.support.test.DomainObjectWithIdAnnotation;
import org.infinispan.spring.repository.support.test.DomainObjectWithoutIdAnnotation;
...
@Test(groups = "unit", testName = "spring.repository.support.SimpleInfinispanRepositoryTest")
public class SimpleInfinispanRepositoryTest {
   ...
   public void constructorShouldRejectNullInfinispanTemplate() {
      new SimpleInfinispanRepository<Object, String>(null,
            new ReflectionEntityInformation<Object, String>(Object.class));
   }

   @Test(expectedExceptions = IllegalArgumentException.class)
   public void constructorShouldRejectNullEntityInformation() {
      new SimpleInfinispanRepository<Object, String>(new InfinispanTemplate(), null);
   }
   ...
   private <T, ID extends Serializable> SimpleInfinispanRepository<T, ID> newSimpleInfinispanRepostitory(
      ...
      final EntityInformation<T, ID> entityInformation = new ReflectionEntityInformation<T, ID>(entityType);
      return new SimpleInfinispanRepository<T, ID>(template, entityInformation);
   }
   ...
   @Test(expectedExceptions = IllegalArgumentException.class)
   public void saveShouldComplainAboutEntityWithoutIdAnnotation() {
      final BasicCache cache = TestCacheManagerFactory.createCacheManager().getCache();

      final SimpleInfinispanRepository<DomainObjectWithoutIdAnnotation, String> objectUnderTest = newSimpleInfinispanRepostitory(
            cache, DomainObjectWithoutIdAnnotation.class, String.class);
      objectUnderTest.save(new DomainObjectWithoutIdAnnotation());
   }
   ...
   @Test(enabled = false)
   public void saveByIdShouldSaveEntityWithoutIdAnnotationUsingProvidedKey() {
      final String key = "saveByIdShouldSaveEntityWithoutIdAnnotationUsingProvidedKey";
      final BasicCache cache = TestCacheManagerFactory.createCacheManager().getCache();
      final DomainObjectWithoutIdAnnotation entity = new DomainObjectWithoutIdAnnotation();
