...
import org.infinispan.spring.repository.InfinispanRepository;
...
public class SimpleInfinispanRepository<T, ID extends java.io.Serializable> implements InfinispanRepository<T, ID> {
   ...
   public void delete(final T entity) {
      ...
      if (id == null) {
         throw new InvalidDataAccessApiUsageException("The provided entity [" + entity
               + "] does not contain a field that is marked as an ID field, i.e. that is annotated with "
               + Id.class.getName() + " or " + "");
      }
      delete(id);
   }
    ...
    * @param entity
    * @return
    * @see org.infinispan.spring.repository.InfinispanRepository#save(java.io.Serializable,
    *      java.lang.Object)
    */
   @Override
